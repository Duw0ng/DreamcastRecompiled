...
if "%~1"=="" (
  echo Uso: run_commercial_recompiled_gpr_experiment.bat "ruta\juego.cdi"
  echo.
...
echo.
echo [DreamcastRecomp 0.0.170] Ejecutando experimento GPR function-wide...
...
echo [INFO] EXPERIMENTO: reactiva DCR_GPR_CACHE=1 para A/B; no es la ruta recomendada de 0.0.170.
