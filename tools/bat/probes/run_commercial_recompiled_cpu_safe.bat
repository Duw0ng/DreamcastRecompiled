...
if "%~1"=="" (
  echo Uso: run_commercial_recompiled_cpu_safe.bat "ruta\juego.cdi"
  echo.
...
echo.
echo [DreamcastRecomp 0.0.170] Ejecutando baseline CPU recuperada...
...
echo [INFO] 0.0.170 CPU-SAFE: mismo PVR GPU/direct-dispatch/tick-batch del runner normal, GPR function-wide desactivado.
