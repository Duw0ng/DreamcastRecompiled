#include "generated_ta_pref_cfg_flow_probe.hpp"
...
BB_6010:
    ...
    // SH-4 @ 0x00006010u: MOV_REG
    ctx.r[5] = ctx.r[4];
    // SH-4 @ 0x00006012u: PREF
    dc_pref_ta_native(runtime, ctx.r[5], 0x00006012u, true);

    return;
}

void register_generated_ta_pref_cfg_flow_probe(DCRuntime& runtime) {
