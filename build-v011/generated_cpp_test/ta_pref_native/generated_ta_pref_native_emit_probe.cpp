#include "generated_ta_pref_native_emit_probe.hpp"
...
BB_5000:
    ...
    // SH-4 @ 0x00005002u: PREF
    dc_pref_ta_native(runtime, ctx.r[4], 0x00005002u);

    return;
}

void register_generated_ta_pref_native_emit_probe(DCRuntime& runtime) {
