...
BB_8C010000:
    ...
    if (runtime.direct_dispatch_ready) {
        ...
        if (!runtime.sh4_async_redirect && ctx.pc == 0x8C010040u) ctx.pc = 0x8C010006u;
    } else {
...
// Generated from _branch_loop @ 0x8C010040u
void recomp_8C010040(SH4Context& ctx, DCRuntime& runtime) {
    bool delayed_t = false;
    std::uint32_t delayed_target = 0u;
    switch (ctx.pc) {
        case 0x8C010040u: goto BB_8C010040;
        case 0x8C010044u: goto BB_8C010044;
        case 0x8C01004Au: goto BB_8C01004A;
        case 0x8C01004Eu: goto BB_8C01004E;
        case 0x8C010054u: goto BB_8C010054;
...
BB_8C010044:
    ...
    if ((ctx.sr & 1u) == 0u) goto BB_8C010044;

BB_8C01004A:
    ctx.pc = 0x8C01004Au;
    DCR_SYNC_CURRENT_PC(runtime, ctx);
    if (dc_runtime_tick_fast(ctx, runtime, 2u)) return;
    // SH-4 @ 0x8C01004Au: CMP_EQ_IMM
    ctx.sr = (ctx.sr & ~1u) | ((ctx.r[0] == static_cast<std::uint32_t>(static_cast<std::int32_t>(15))) ? 1u : 0u);
    // SH-4 @ 0x8C01004Cu: BRANCH_IF_TRUE
    if ((ctx.sr & 1u) != 0u) goto BB_8C010054;

BB_8C01004E:
    ctx.pc = 0x8C01004Eu;
    DCR_SYNC_CURRENT_PC(runtime, ctx);
    if (dc_runtime_tick_fast(ctx, runtime, 3u)) return;
    // SH-4 @ 0x8C01004Eu: MOV_IMM
    ctx.r[0] = static_cast<std::uint32_t>(static_cast<std::int32_t>(-1));
    // SH-4 @ 0x8C010050u: BRANCH
    goto BB_8C010056;
...
void register_recompiled_program(DCRuntime& runtime) {
    ...
    runtime.register_target(0x8C010040u, &recomp_8C010040); // _branch_loop block
    runtime.register_target(0x8C010044u, &recomp_8C010040); // _branch_loop block
    runtime.register_target(0x8C01004Au, &recomp_8C010040); // _branch_loop block
    runtime.register_target(0x8C01004Eu, &recomp_8C010040); // _branch_loop block
    runtime.register_target(0x8C010054u, &recomp_8C010040); // _branch_loop block
    runtime.register_target(0x8C010056u, &recomp_8C010040); // _branch_loop block
}
