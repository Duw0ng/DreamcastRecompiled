...
BB_8C010000:
    ...
    // SH-4 @ 0x8C010000u: LOAD_LITERAL32 -> _helper
    ctx.r[0] = dc_load_pc_literal32(runtime, 0x8C010000u, 0x8C010010u, 0x8C010040u);
    // SH-4 @ 0x8C010002u: PUSH_PR
    ctx.r[15] -= 4u;
    dc_guest_write32_hot(runtime, ctx.r[15], ctx.pr);
    // SH-4 @ 0x8C010004u: SAVE_DYNAMIC_ABS_TARGET
    delayed_target = ctx.r[0];
    // SH-4 @ 0x8C010004u: DYNAMIC_CALL
    ctx.pr = 0x8C010008u;
...
void recomp_8C010040(SH4Context& ctx, DCRuntime& runtime) {
    ...
    switch (ctx.pc) {
        ...
        case 0x8C010046u: goto BB_8C010046;
...
BB_8C010040:
    ...
    DCR_SYNC_CURRENT_PC(runtime, ctx);
    if (dc_runtime_tick_fast(ctx, runtime, 4u)) return;
    // SH-4 @ 0x8C010040u: PUSH_PR
    ctx.r[15] -= 4u;
    dc_guest_write32_hot(runtime, ctx.r[15], ctx.pr);
    // SH-4 @ 0x8C010042u: CALL
    ctx.pr = 0x8C010046u;
    if (runtime.direct_dispatch_ready) {
        ...
        if (!runtime.sh4_async_redirect && ctx.pc == 0x8C010080u) ctx.pc = 0x8C010046u;
    } else {
        ++runtime.direct_dispatch_fallbacks;
        call_recompiled(ctx, runtime, 0x8C010080u);
    }
    if (runtime.sh4_async_redirect || ctx.pc != 0x8C010046u) return;
    ctx.pc = 0x8C010046u;
...
// Generated from _leaf @ 0x8C010080u
...
BB_8C010080:
    ...
    DCR_SYNC_CURRENT_PC(runtime, ctx);
    if (dc_runtime_tick_fast(ctx, runtime, 4u)) return;
    // SH-4 @ 0x8C010080u: MOV_IMM
    ctx.r[0] = static_cast<std::uint32_t>(static_cast<std::int32_t>(41));
    // SH-4 @ 0x8C010082u: RETURN
    ctx.pc = ctx.pr;
    return;
...
void register_recompiled_program(DCRuntime& runtime) {
    ...
    runtime.register_target(0x8C010046u, &recomp_8C010040); // _helper block
    runtime.register_target(0x8C010080u, &recomp_8C010080); // _leaf block
}
